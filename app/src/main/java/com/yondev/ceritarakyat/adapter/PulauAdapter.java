...
import com.yondev.ceritarakyat.DaftarCeritaActivity;
import com.yondev.ceritarakyat.R;

public class PulauAdapter extends BaseAdapter {	
	private Activity activity;
	private LayoutInflater inflater;
	private List<Integer> dtlist;
	public PulauAdapter(Activity activity) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            vi = inflater.inflate(R.layout.pulau_item, null);
        ...
        holder.img.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(activity, DaftarCeritaActivity.class);
				intent.putExtra("pulau", position);
